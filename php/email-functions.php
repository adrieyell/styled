 ...
 * @param string $trackingNumber  Tracking number (if any)
...
function send_order_status_email($pdo, $orderId, $oldStatus, $newStatus, $trackingNumber = null)
{
    ...
    $trackingHtml = '';
    if ($trackingNumber) {
        $trackingHtml = "<p style='margin:12px 0 0;'><strong>Tracking Number:</strong> {$trackingNumber}</p>";
    }
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,.06);">
            ...
            <tr><td style="padding:40px;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;margin-bottom:28px;">
                    <tr><td style="padding:6px 8px;color:#7a6a5a;">Subtotal</td><td style="padding:6px 8px;text-align:right;">₱" . number_format($subtotal, 2) . "</td></tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;margin-bottom:32px;">
                    <tr><td width="50%" style="vertical-align:top;padding-right:16px;">
                        <p style="margin:0 0 6px;font-weight:500;color:#7a6a5a;text-transform:uppercase;font-size:11px;">Shipping To</p>
                        <p style="margin:0;line-height:1.6;">{$address}</p>
                    </td><td width="50%" style="vertical-align:top;">
                        <p style="margin:0 0 6px;font-weight:500;color:#7a6a5a;text-transform:uppercase;font-size:11px;">Payment Method</p>
...
HTML;
    ...
    if ($trackingNumber) $textBody .= "Tracking number: {$trackingNumber}\n";
